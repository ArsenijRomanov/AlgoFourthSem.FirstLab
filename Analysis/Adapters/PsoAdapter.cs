...
public sealed class PsoAdapter : IOptimizationAdapter
{
    private readonly ParticleSwarmOptimization _algorithm;
    ...
    public double BestFitness => _algorithm.GlobalBestFitness;
    public IReadOnlyList<double> BestPoint => _algorithm.GlobalBestPosition;
